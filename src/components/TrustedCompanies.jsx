...
export default function TrustedCompanies() {
  ...
  return (
    <Box ref={ref} sx={{ py: { xs: 8, md: 12 }, bgcolor: "#f9f9ff" }}>
        ...
        <motion.div variants={containerVariants} initial="hidden" animate={inView ? "visible" : "hidden"}>
          <motion.div variants={itemVariants}>
            ...
            >
              ...
              <Box component="span" sx={{ color: "#51DC68" }}>Reverse Diabetes</Box>
              <Box component="span" sx={{ color: "#071A2B" }}> & </Box>
              <Box component="span" sx={{ color: "#1BB3F7" }}>Support Weight Loss!</Box>
            </Typography>
          </motion.div>
